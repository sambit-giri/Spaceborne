...
path_import = '/Users/davide/Documents/Lavoro/Programmi/SSC_restructured/jobs/IST_NL/output/covmat'
...
GO_or_GS = 'GO'
nbl = 20
ind = np.genfromtxt('/Users/davide/Documents/Lavoro/Programmi/SSC_restructured/jobs/IST_NL/input/indici_cloe_like.dat').astype(int) - 1
ind_LL = ind[:55, :]
