...
class PycclClass():
    ...
    def __init__(self, fiducial_pars_dict, ell_grid, general_cfg,
                              covariance_cfg):
        ...
        # functions
        self.flat_fid_pars_dict = mm.flatten_dict(fiducial_pars_dict)
        ...
        self.cosmo_ccl = cosmo_lib.instantiate_cosmo_ccl_obj(cosmo_dict_ccl,
                                                        self.fiducial_pars_dict['other_params']['camb_extra_parameters'])
