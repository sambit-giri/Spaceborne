...
path = '/Users/davide/Documents/Lavoro/Programmi/SSC_restructured/jobs/PyCCL_forecast'
path_mm = '/Users/davide/Documents/Lavoro/Programmi/SSC_restructured/lib'
path_plotlib = '/5_plots/plot_FM'
path_config = '/Users/davide/Documents/Lavoro/Programmi/SSC_restructured/jobs/PyCCL_forecast/configs'

sys.path.append(path_plotlib)
sys.path.append(path_config)
sys.path.append(path_mm)


import config_PyCCL_forecast as config_PyCCL_forecast
...
FM_dict = {}
uncert_dict = {}
plot_config = config_PyCCL_forecast.plot_config
general_config = config_PyCCL_forecast.general_config
covariance_config = config_PyCCL_forecast.covariance_config
