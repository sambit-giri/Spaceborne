...
general_cfg = {
    ...
    'model': 'wzwaCDM-GR-TB',
    'specs': 'idMag2-idRSD1-idFS1-idSysWL3-idSysGC6',
    ...
    # '//dv-3x2pt-32-wzwaCDM-NonFlat-GR-TB-idMag0-idRSD0-idFS0-idSysWL3-idSysGC4-ED13-M230-ZM00.dat'
    'cl_folder': f'{SPV3_folder}' + 'DataVectors/Noiseless/{probe:s}/FS2',
    'rl_folder': f'/Users/davide/Documents/Lavoro/Programmi/common_data/vincenzo/SPV3_07_2022/',
    'cl_filename': 'dv-{probe:s}-{model:s}-{specs:s}-{EP_or_ED:s}{zbins:02d}-M{magcut:03d}-ZM{zcut:02d}.dat',
