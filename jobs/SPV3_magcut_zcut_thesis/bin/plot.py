...
for probe in probes:
    for ML, ZL, MS, ZS in zip(ML_list, ZL_list, MS_list, ZS_list):
        ...
        FM_noBNT_path = f'/home/cosmo/davide.sciotti/data/Spaceborne/jobs/SPV3_magcut_zcut/output' \
                        f'/Flagship_{flagship_version}/FM/BNT_False'
        FM_BNT_path = f'/home/cosmo/davide.sciotti/data/Spaceborne/jobs/SPV3_magcut_zcut/output' \
