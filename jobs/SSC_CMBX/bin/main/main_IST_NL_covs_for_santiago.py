...
for NL_flag in range(5):
    ...
    # to compute the 10D 3x2pt covariance
    covariance_config['compute_covariance_in_blocks'] = True
    ...
    # produce 6D for Santiago:
    cov_WL_GO_6D = mm.cov_4D_to_6D(cov_dict['cov_WL_GO_4D'], nbl=20, zbins=10, probe='LL', ind=ind[:55])
    cov_WL_GS_6D = mm.cov_4D_to_6D(cov_dict['cov_WL_GS_4D'], nbl=20, zbins=10, probe='LL', ind=ind[:55])

    # save in for Santiago:
    # 2D
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-ShearShear-Gauss-20bins-NL_flag_{NL_flag}_2D.npy', cov_dict['cov_WL_GO_2D'])
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-ShearShear-GaussSSC-20bins-NL_flag_{NL_flag}_2D.npy', cov_dict['cov_WL_GS_2D'])
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-3x2pt-Gauss-20bins-NL_flag_{NL_flag}_2D.npy', cov_dict['cov_3x2pt_GO_2D'])
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-3x2pt-GaussSSC-20bins-NL_flag_{NL_flag}_2D.npy', cov_dict['cov_3x2pt_GS_2D'])

    # 4D
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-ShearShear-Gauss-20bins-NL_flag_{NL_flag}_4D.npy', cov_dict['cov_WL_GO_4D'])
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-ShearShear-GaussSSC-20bins-NL_flag_{NL_flag}_4D.npy', cov_dict['cov_WL_GS_4D'])
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-3x2pt-Gauss-20bins-NL_flag_{NL_flag}_4D.npy', cov_dict['cov_3x2pt_GO_4D'])
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-3x2pt-GaussSSC-20bins-NL_flag_{NL_flag}_4D.npy', cov_dict['cov_3x2pt_GS_4D'])

    # 6D - WL
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-ShearShear-Gauss-20bins-NL_flag_{NL_flag}_6D.npy', cov_WL_GO_6D)
    np.save(job_path / f'output/covmat/covs_for_Santiago/CovMat-ShearShear-GaussSSC-20bins-NL_flag_{NL_flag}_6D.npy', cov_WL_GS_6D)


    # 10D - 3x2pt, pkl
    # save the 10D covariance as a dict
    # TODO use pandas dataframe
    with open(job_path / f'output/covmat/covs_for_Santiago/cov_3x2pt_GO_10D.pkl', "wb") as file:
        pickle.dump(cov_dict['cov_3x2pt_GO_10D'], file)
