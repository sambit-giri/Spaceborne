...
for NL_flag in range(5):
    ...
    np.save(job_path / f'output/covmat/CovMat-ShearShear-SSC-20bins{NL_flag_string_cov}_4D.npy', cov_dict[f'cov_WL_SS_4D'])
    np.save(job_path / f'output/covmat/CovMat-PosPos-SSC-20bins{NL_flag_string_cov}_4D.npy', cov_dict[f'cov_GC_SS_4D'])
    np.save(job_path / f'output/covmat/CovMat-3x2pt-SSC-20bins{NL_flag_string_cov}_4D.npy', cov_dict[f'cov_3x2pt_SS_4D'])
