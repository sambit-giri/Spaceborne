...
def halomod_Tk3D_SSC(
    ...
    bA_tosave, bB_tosave = [np.zeros((len(a_arr), len(k_use))) for _ in range(2)]
    for ia, aa in enumerate(a_arr):
        ...
        if prof.is_number_counts or prof2.is_number_counts:
            ...
            bA_tosave[ia] = _get_counterterm(prof, prof2, prof12_2pt,
        ...
        if prof3.is_number_counts or prof4.is_number_counts:
            if (prof, prof2, prof12_2pt) == (prof3, prof4, prof34_2pt):
                ...
                bB_tosave[ia] = _get_counterterm(prof3, prof4, prof34_2pt,
                                                 norm3, norm4, i11_3, i11_4)[2]

    dpk12, dpk34, use_log = _logged_output(dpk12, dpk34, log=use_log)

    # transpose pk files to have [k, z] instead of [z, k]
    np.savetxt("/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/a_arr.txt", a_arr)
    np.savetxt("/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/k_1overMpc.txt", k_use)

    np.save(f"/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/dpk12_is_number_counts{prof.is_number_counts}.npy", dpk12.T)
    np.save(f"/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/dpk34_is_number_counts{prof3.is_number_counts}.npy", dpk34.T)
    np.save("/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/pk2d.npy", pk2d_array_tosave.T)
    np.save("/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/dpk2d.npy", dpk2d_array_tosave.T)
    np.save("/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/pk1d.npy", pk.T)
    np.save("/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/dpk1d.npy", dpk.T)
    np.save(f"/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/bA.npy", bA_tosave)
    np.save(f"/Users/davide/Documents/Lavoro/Programmi/PyCCL_SSC/output/pyccl_responses/davide/bB.npy", bB_tosave)
    print('Halomodel Pk responses saved')
