...
def sigma2_z1z2_wrap(z_grid_ssc_integrands, k_grid_sigma2, cosmo_ccl, which_sigma2_b, area_deg2_in, nside_mask):
    ...
    if which_sigma2_b == 'full_curved_sky':
        ...
        raise NotImplementedError('not implemented yet, simply import the necessary ingredients and repeat code above')
